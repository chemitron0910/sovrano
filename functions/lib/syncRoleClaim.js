...
exports.syncRoleClaim = void 0;
const logger = __importStar(require("firebase-functions/logger"));
const firebase_1 = require("./firebase");
const functions = __importStar(require("firebase-functions/v1"));
exports.syncRoleClaim = functions
    ...
    if (newRole) {
        await (0, firebase_1.getAuth)().setCustomUserClaims(uid, { role: newRole });
        logger.info(`Setting role ${newRole} for UID ${uid}`);
    }
});
//# sourceMappingURL=syncRoleClaim.js.map